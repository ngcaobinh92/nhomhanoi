  ...
  <form class="frm-pr-add" method="post" action="">
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        <?php endif; ?>
        <input class="form-control" name="title" type="text" value="<?php echo e($data->title); ?>" required>
      </div>

      <div class="form-group">
        <label>Đường dẫn danh mục</label>
        <input class="form-control" name="slug" type="text" value="<?php echo e($data->slug); ?>">
      </div>
      ...
      <div class="form-group">
        ...
        <select name="parent" class="form-control">
          ...
          <?php $__currentLoopData = $categories_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($cp->parent == 0): ?>
            <option value="<?php echo e($cp->id); ?>" <?php if($data->parent == $cp->id): ?><?php echo e('hidden selected'); ?><?php endif; ?>><?php echo e($cp->title); ?></option>
              <?php $__currentLoopData = $categories_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cp2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <option value="<?php echo e($cp2->id); ?>" <?php if($data->parent == $cp2->id): ?><?php echo e('hidden selected'); ?><?php endif; ?>>-- &nbsp;&nbsp;<?php echo e($cp2->title); ?></option>
                <?php endif; ?>
      ...
      <div class="form-group">
        <label>Mô tả</label>
        <textarea class="form-control" rows="3" name="description"><?php echo e($data->description); ?></textarea>
      </div>
      ...
      <div class="form-group">
        ...
        <select name="status" class="form-control">
          <option value="public" <?php if($data->status == 'public'): ?><?php echo e('hidden selected'); ?><?php endif; ?>>Hiển thị</option>
          <option value="preview" <?php if($data->status == 'preview'): ?><?php echo e('hidden selected'); ?><?php endif; ?>>Ẩn</option>
        </select>
      </div>

      <div class="form-group">
        <label>Ảnh mô tả</label>
        <input type="hidden" name="featured_image" id="featured_image" value="<?php echo e($data->featured_image); ?>">
        <img src="<?php echo e($data->featured_image); ?>" id="featured_image_src" class="featured_image" width="100%">
        <p><a class="btn btn-default imageUpload">Chọn ảnh</a></p>
      </div>

      <div class="form-group">
        <label>Ảnh phụ</label>
        <input type="hidden" name="thump_image" id="featured_icon" value="<?php echo e($data->thump_image); ?>">
        <img src="<?php echo e($data->thump_image); ?>" id="featured_icon_src" class="featured_icon" width="100%">
