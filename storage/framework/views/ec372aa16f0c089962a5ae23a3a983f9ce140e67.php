              ...
              <div class="tabs">
                ...
                <div class="tab-content tab-body">
                  ...
                  <div class="tab-pane" id="more2">
                    <p>- Cách 1: Đặt mua onlne</p>
                    <p>Các bạn chỉ cần gọi điện thoại đến số <?php echo e($configs->hotline); ?> để đặt hàng. Nhân viên chúng tôi luôn sẵn sàng phục vụ, tư vấn và hỗ trợ quý khách.</p>
                    <p>- Cách 2: Truy cập website: <?php echo e(URL::to('/')); ?>.</p>
                    <p>Tại danh mục sản phẩm, bạn có thể tuỳ chọn mẫu sản phẩm ưng ý, click vào từng sản phẩm để biết thêm thông tin, hình ảnh sản phẩm, khuyến mại (nếu có). Cuối cùng đặt mua hàng theo số: <?php echo e($configs->hotline); ?></p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="" id="related_products">
            <div class="block-sidebar-product">
              ...
              <div class="block-sidebar-product-content">
                <?php if(count($data['product']->relate_product) > 0): ?>
                  <?php $__currentLoopData = $data['product']->relate_product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relate_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="item">
                    <div class="item-inner transition">
                      <div class="image">
                        <a class="lt-image" href="<?php echo e($relate_product->slug); ?>" target="_self" title="<?php echo e($relate_product->title); ?>">
                          <img src="<?php echo e($relate_product->featured_image); ?>" class="img-1 product" alt="<?php echo e($relate_product->title); ?>">
                        </a>
                      </div>
                      <div class="caption">
                        <h4><a href="<?php echo e($relate_product->slug); ?>" title="<?php echo e($relate_product->title); ?>" target="_self"><?php echo e($relate_product->title); ?></a></h4>
                        <p class="price">
