      ...
      <div class="table-responsive">
        <table class="table table-bordered table-striped mb-none" id="datatable-default">
          ...
          <tbody>
            ...
            <tr>
              <td class="center"><?php echo e($new->id); ?></td>
              <td><a href="cms/tin-tuc/edit/<?php echo e($new->id); ?>" title="<?php echo e($new->title); ?>"><?php echo e($new->title); ?></a></td>
              <?php
                switch ($new->status) {
                  case 'public':
                    $status = 'Hiện';
              ...
              <td class="center"><?php echo e($new->created_at); ?></td>
              <td class="center"><?php echo e($new->updated_at); ?></td>
              <td class="center actions-hover actions-fade">
                <a href="cms/tin-tuc/edit/<?php echo e($new->id); ?>" title="Sửa"><i class="fa fa-pencil"></i></a>&emsp;
                <a href="cms/tin-tuc/delete/<?php echo e($new->id); ?>" title="Xóa}" class="btn-delete" data-id="<?php echo e($new->id); ?>"><i class="fa fa-trash-o"></i></a>
              </td>
            </tr>
