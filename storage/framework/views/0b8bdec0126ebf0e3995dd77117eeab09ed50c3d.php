			...
			<div class="panel panel-sign">
				<div class="panel-title-sign mt-xl text-right">
					<select onchange="location = this.value;">
						<option hidden><?php echo e(trans('cms.ngon_ngu_hien_thi')); ?></option>
		                <?php
	                	...
	                	<?php if(Session::has('website_language')): ?>
	                		<option hidden selected value="<?php echo route('user.change-language', ['language' => $language_theme->lang_code]); ?>"> <?php echo e($language_theme->lang_name); ?></option>
	                	<?php endif; ?>

                        <?php $__currentLoopData = $website_language; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<option value="<?php echo route('user.change-language', ['language' => $language->lang_code]); ?>"><?php echo e($language->lang_name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					</select>
					<h2 class="title text-uppercase text-bold m-none"><i class="fa fa-user mr-xs"></i> <?php echo e(trans('cms.dang_nhap')); ?> </h2>
				</div>
				<div class="panel-body">
					<form action="" method="post">
						...
						<div class="form-group mb-lg">
							<label><?php echo e(trans('cms.tai_khoan')); ?></label>
							<div class="input-group input-group-icon">
								<input name="username" type="email" class="form-control input-lg" placeholder="<?php echo e(trans('cms.nhap_tai_khoan')); ?>..." />
						...
						<div class="form-group mb-lg">
							<label><?php echo e(trans('cms.mat_khau')); ?></label>
							<div class="input-group input-group-icon">
								<input name="password" type="password" class="form-control input-lg" placeholder="<?php echo e(trans('cms.nhap_mat_khau')); ?>..." />
								<span class="input-group-addon">
									<span class="icon icon-lg">
							...
							<div class="clearfix">
								<div class="pull-left checkbox-custom checkbox-default">
									...
									<label for="RememberMe"><?php echo e(trans('cms.luu_dang_nhap')); ?></label>
								</div>
								<a href="cms/recover" class="pull-right checkbox-custom checkbox-default"><?php echo e(trans('cms.quen_mat_khau')); ?></a>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-sm-4 text-right">
								<button type="submit" class="btn btn-primary hidden-xs"><?php echo e(trans('cms.dang_nhap')); ?></button>
								<button type="submit" class="btn btn-primary btn-block btn-lg visible-xs mt-lg"><?php echo e(trans('cms.dang_nhap')); ?></button>
							</div>
						</div>
					</form>
				</div>
...
</html><?php /**PATH C:\xampp\htdocs\nhomdaiviet.com.test\resources\views/cms/master/login.blade.php ENDPATH**/ ?>