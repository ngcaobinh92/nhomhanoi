              ...
              <div class="panel-body">
                ...
                <div class="col-sm-12 form-type">
                  <div class="form-group">
                    ...
                    <textarea class="form-control mce_basic" name="description"><?php echo e(old('description')); ?></textarea>
                  </div>
                </div>
              ...
              <div class="panel-body">
                ...
                <div class="col-sm-12 form-type">
                  <div class="form-group">
                    <label class="control-label">Ảnh mô tả phụ</label>
                      <input type="hidden" name="thump_image" id="featured_icon" value="<?php echo e(old('thump_image')); ?>">
                      <img src="<?php echo e(old('thump_image')); ?>" id="featured_icon_src" class="thumbnail" width="100%">
                        ...
                        <?php if($cp->parent == 0): ?>
                          <?php $__currentLoopData = $categories_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cp2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php $__currentLoopData = $categories_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cp3): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              ...
                              <option value="<?php echo e($cp2->id); ?>">-- &nbsp;&nbsp;<?php echo e($cp3->title); ?></option>
                            <?php endif; ?>
                ...
                <div class="col-sm-12 form-type">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="quantity" min="0" step="1" value="<?php echo e(old('quantity')); ?>" required="">
                ...
                <div class="col-sm-12 form-type">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="origin_price" min="0" step="any" value="<?php echo e(old('origin_price')); ?>" required="">
                ...
                <div class="col-sm-12 form-type">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="sale" max="100" min="0" step="any" value="<?php echo e(old('sale')); ?>" required="">
