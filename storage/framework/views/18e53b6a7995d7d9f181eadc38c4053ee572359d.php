                  ...
                  <table class="table table-condensed">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="cart_total">
                          <p class="cart_total_price"><?php echo e($item->subtotal); ?> VNĐ</p>
                        </td>
                        <td>
                          <a class="cart_change" data-href='<?php echo e(url("gio-hang?product_id=$item->id&remove=1")); ?>'><i class="fa fa-times"></i></a>
                        </td>
                      </tr>
                ...
                <div class="contact">
                  ...
                  <div class="contact-info">
                    <div class="shop-name">
                      ...
                      <label>PHÂN PHỐI NHÔM HÀ NỘI</label>    
                    </div>
                    <div class="address"> 
        ...
        <div class="modal-content animate">
          ...
          <div class="modal-body" id="normal-login" style="display: none;">
              ...
              <div class="modal-body">
                <div class="form-group">
                  ...
                  <div class="input-group pb-modalreglog-input-group">
                    <input type="email" class="form-control" name="email" data-id="email" placeholder="Email" required>
            ...
            <form id="recovery" style="display: none;" method="post" action="tai-khoan/phuc-hoi">
              <div class="modal-body">
                <div class="form-group">
                  <label>Chúng tôi sẽ gửi email chứa đường dẫn đến trang đặt lại mật khẩu cho bạn. Vui lòng điền địa chỉ email bạn đã dùng để đăng ký tài khoản!</label>
                </div>
                <div class="form-group">
                  <label for="reemail">Email <span class="required">*</span></label>
                  <div class="input-group pb-modalreglog-input-group">
                    <input type="email" class="form-control" name="email" data-id="email" placeholder="Email" required>
                    <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
                  </div>
            ...
            <form id="register" method="post" action="tai-khoan/dang-ky">
              <div class="modal-body">
                ...
                <div class="form-group">
                  <label for="email">Email <span class="required">*</span></label>
                  <div class="input-group pb-modalreglog-input-group">
                    <input type="text" class="form-control" name="email" data-id="email" placeholder="Tên" required>
                    <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
                  </div>
                </div>
                <div class="form-group">
...
</html><?php /**PATH D:\xampp_7.2.34\htdocs\nhomdaiviet.com.test\resources\views/site/master/default.blade.php ENDPATH**/ ?>