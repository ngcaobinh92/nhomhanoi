					...
					<tr>
						<td style="<?php echo e($style['email-masthead']); ?>">
							<a style="<?php echo e($fontFamily); ?> <?php echo e($style['email-masthead_name']); ?>" href="<?php echo e(url('/')); ?>" target="_blank"> 
								<img src="<?php echo e(asset('public/img/logo.png')); ?>" height="150px"/>
							</a>
							<br/><br/>
							<div align="center">Công ty CP Phân phối nhôm HN</div>
						</td>
					</tr>
					<tr>
						<td style="<?php echo e($style['email-body']); ?>" width="100%">
							<table style="<?php echo e($style['body_action']); ?>" align="center" width="100%" cellpadding="0" cellspacing="0">
								<tr>
									<td align="center"><?php echo e($content); ?>

										<br/>
										<a href="<?php echo e($active_code); ?>"><strong><?php echo e($active_code); ?></strong></a>.
										<br/>Yêu cầu có hiệu lực trong 24h.
									</td>
								</tr>
							</table>
						</td>
							...
							<table style="<?php echo e($style['email-footer']); ?>" align="center" width="570" cellpadding="0" cellspacing="0">
								<tr>
									<td style="<?php echo e($fontFamily); ?> <?php echo e($style['email-footer_cell']); ?>">
										<p style="<?php echo e($style['paragraph-sub']); ?>"> &copy; 2020 
											<a style="<?php echo e($style['anchor']); ?>" href="<?php echo e(url('/')); ?>" target="_blank">Công ty CP Phân phối nhôm HN</a>.All rights reserved. 
										</p>
									</td>
								</tr>
							</table>
...
</html><?php /**PATH D:\laragon\www\nhomdaiviet\resources\views/cms/master/email/authcode.blade.php ENDPATH**/ ?>