						...
						var elf = $('#elfinder').elfinder({
								...
								getFileCallback : function(file) {
									...
									if(mode == 'icon'){
										...
										$( "#slide_image_"+id, window.opener.document ).val(file);

										$( "#slide_image_"+id+"_src", window.opener.document ).attr('src',file);

										$( "#slide_image_"+id+"_href", window.opener.document ).attr('href',file);
