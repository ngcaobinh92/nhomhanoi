        ...
        <table class="table table-bordered table-striped mb-none" id="datatable-default">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a href="cms/tin-tuc/edit/{{$new->id}}" title="{{$new->title}}">{{$new->title}}</a></td>
              @php
                switch ($new->status) {
                  case 'public':
                    $status = 'Hiện';
              ...
              <td class="center actions-hover actions-fade">
                <a href="cms/tin-tuc/edit/{{$new->id}}" title="Sửa"><i class="fa fa-pencil"></i></a>&emsp;
                <a href="cms/tin-tuc/delete/{{$new->id}}" title="Xóa}" class="btn-delete" data-id="{{$new->id}}"><i class="fa fa-trash-o"></i></a>
              </td>
            </tr>
            @endforeach
          </tbody>
