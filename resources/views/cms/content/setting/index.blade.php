	    ...
	    <input type="hidden" name="_token" value="{{csrf_token()}}">
							...
							<div class="form-group">
								...
								<div class="col-md-9 control-label">
									<div class="input-group">
										...
										<input class="form-control" name="google_plus" value="{{$cms_siteInfo->google_plus}}">
									</div>
								</div>
							</div>
						</div>
							...
							<div class="form-group">
								...
								<div class="col-md-9 control-label">
									<div class="input-group">
										...
										<input class="form-control" name="facebook" value="{{$cms_siteInfo->facebook}}">
									</div>
								</div>
							</div>
						</div>
							...
							<div class="form-group">
								...
								<div class="col-md-9 control-label">
									<div class="input-group">
										...
										<input class="form-control" name="hotline" value="{{$cms_siteInfo->hotline}}">
									</div>
								</div>
							</div>
						</div>
							...
							<div class="form-group">
								...
								<div class="col-md-9 control-label">
									<div class="input-group">
										...
										<input class="form-control" name="email" value="{{$cms_siteInfo->email}}">
									</div>
								</div>
							</div>
						</div>
							...
							<div class="form-group">
								...
								<div class="col-md-9 control-label">
									<div class="input-group">
										...
										<input class="form-control" name="twitter" value="{{$cms_siteInfo->twitter}}">
									</div>
								</div>
							</div>
						</div>
							...
							<div class="form-group">
								...
								<div class="col-md-9 control-label">
									<div class="input-group">
										...
										<input class="form-control" name="pinterest" value="{{$cms_siteInfo->pinterest}}">
									</div>
								</div>
							</div>
						</div>
							...
							<div class="form-group">
								...
								<div class="col-md-9 control-label">
									<div class="input-group">
										...
										<input class="form-control" name="zalo" value="{{$cms_siteInfo->zalo}}">
									</div>
								</div>
							</div>
						</div>
							...
							<div class="form-group">
								...
								<div class="col-md-9 control-label">
									<div class="input-group">
										...
										<input class="form-control" name="address" value="{{$cms_siteInfo->address}}">
									</div>
								</div>
							</div>
						</div>
            ...
            <div class="col-sm-12 form-type">
              <div class="form-group">
                ...
                <textarea class="form-control mce_basic" name="showroom">{{$cms_siteInfo->showroom}}</textarea>
              </div>
            </div>
            ...
            <div class="col-sm-12 form-type">
              <div class="form-group">
                ...
                <textarea class="form-control mce_basic" name="factory">{{$cms_siteInfo->factory}}</textarea>
              </div>
            </div>
            ...
            <div class="col-sm-12 form-type">
              <div class="form-group">
                ...
                <textarea class="form-control" name="google_map" rows="7">{{$cms_siteInfo->google_map}}</textarea>
              </div>
            </div>
...
<div class="row">
	<section class="panel">
	    ...
	    <input type="hidden" name="_token" value="{{csrf_token()}}">
			<div class="panel-body">
    	@foreach($cms_cat as $cat)
    		@if(count($cat->child) == 0)
    		<div class="form-group">
					<label class="col-md-3 control-label">{{$cat->title}}</label>
					<div class="col-md-6">
						@foreach($cms_role as $role)
						<label class="checkbox-inline">
							<input type="checkbox" value="{{$role->id}}" @if(in_array($role->id, $cat->require)){{'checked'}}@endif name="{{$cat->id}}[]"> {{$role->title}}
						</label>
						@endforeach
					</div>
				</div>
    		...
    		<div class="form-group">
					...
					@foreach($cat->child as $catchild)
					<div class="form-group">
						<label class="col-md-3">{{$catchild->title}}</label>
						<div class="col-md-6">
							@foreach($cms_role as $role)
							<label class="checkbox-inline">
								<input type="checkbox" value="{{$role->id}}" @if(in_array($role->id, $catchild->require)){{'checked'}}@endif name="{{$catchild->id}}[]"> {{$role->title}}
							</label>
							@endforeach
						</div>
					</div>
            ...
            <div class="content-with-menu-container">
              <div class="mg-main">
                <div class="row mg-files" data-sort-destination data-sort-id="media-gallery">
                  ...
                  <input type="hidden" class="total" value="{{count($cms_slide)}}">
                  @if(count($cms_slide) > 0)
                    @foreach($cms_slide as $key => $slider)
                      ...
                      <div class="thumbnail">
                        <div class="thumb-preview">
                          <a class="thumb-image" id="slide_image_file_{{$key+1}}_href" href="{{$slider->image}}">
                            <img class="img-responsive" alt="Project" id="slide_image_file_{{$key+1}}_src" src="{{$slider->image}}">
                          </a>
