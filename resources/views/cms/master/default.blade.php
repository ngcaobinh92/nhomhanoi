	...
	<section class="body">
		...
		<header class="header">
			<div class="logo-container">
				...
				<input type="hidden" id="langfont" value="{{\Session::get('website_language')}}">
			...
			<div class="header-right">
				...
				<div id="userbox" class="userbox">
					<a href="#" data-toggle="dropdown">
						<div class="profile-info">
							<span class="name">{{ trans('cms.ngon_ngu_hien_thi') }}</span>
							<span class="role">{{DB::table('language')->where('lang_code', $website_language)->first()->lang_name}}</span>
						</div>
					...
					<div class="dropdown-menu">
						<ul class="list-unstyled">
							...
							@if($list != null)
								...
								<li>
									<a role="menuitem" tabindex="-1" href="{!! route('user.change-language', ['language' => $lang->lang_code]) !!}">
										<img src="public/img/flags/1x1/{{$lang->lang_flag}}" class="flag">{{$lang->lang_name}}
									</a>
								</li>
								@endforeach
							@endif
				...
				<div id="userbox" class="userbox">
					<a href="#" data-toggle="dropdown">
						<div class="profile-info">
							<span class="name">{{ trans('cms.ngon_ngu_bai_viet') }}</span>
							<span class="role">{{DB::table('language')->where('lang_code', $post_language)->first()->lang_name}}</span>
						</div>
					...
					<div class="dropdown-menu">
						<ul class="list-unstyled">
							...
							@if($list != null)
								@foreach($list as $lang)
								<li>
									<a role="menuitem" tabindex="-1" href="{!! route('user.change-post-lang', ['language' => $lang->lang_code]) !!}">
										<img src="public/img/flags/1x1/{{$lang->lang_flag}}" class="flag">{{$lang->lang_name}}
									</a>
								</li>
								@endforeach
				...
				<div id="userbox" class="userbox">
					<a href="#" data-toggle="dropdown">
						...
						<div class="profile-info">
							<span class="name">{{$adminLogin->user_name}}</span>
			                @php
					...
					<div class="dropdown-menu">
						<ul class="list-unstyled">
							<li class="divider"></li>
							<li>
								<a role="menuitem" tabindex="-1" href="cms/user/edit/{{$adminLogin->id}}"><i class="fa fa-user"></i> {{ trans('cms.thong_tin_ca_nhan') }}</a>
							</li>
							<li>
								<a role="menuitem" tabindex="-1" href="cms/logout"><i class="fa fa-power-off"></i> {{ trans('cms.thoat') }}</a>
							</li>
						</ul>
					</div>
				</div>
